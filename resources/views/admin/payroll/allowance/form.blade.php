									...
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												...
												<div class="col-md-8">
													{!! Form::number('percentage_of_basic',Input::old('percentage_of_basic'), $attributes = array('class'=>'form-control required percentage_of_basic','step'=>'any', 'id'=>'percentage_of_basic','placeholder'=>__('allowance.percentage_of_basic'),'min'=>'0','max'=>'100')) !!}
												</div>
											</div>
										</div>
									</div>
